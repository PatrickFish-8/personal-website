...
function Chat() {
    ...
    async function getResponse() {
        try {
            if (!userInput) return
            const response = await fetch('https://jdt-fall-24-personal-website-e17ab1182ae3.herokuapp.com/chat', {
                method: 'POST',
                headers: {
            ...
            fetch('https://jdt-fall-24-personal-website-e17ab1182ae3.herokuapp.com/add', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    function deleteChatbox(index) {
        ...
        fetch('https://jdt-fall-24-personal-website-e17ab1182ae3.herokuapp.com/delete', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    useEffect(() => {
        fetch('https://jdt-fall-24-personal-website-e17ab1182ae3.herokuapp.com/logs')
            .then(res => res.json())
            .then(data => {
                let newMessages = []
    ...
    return (
        <div id="chat">
            <form onSubmit={(e) => e.preventDefault()}>
                ...
                <input type="text" name='user-input' id="questionInput" placeholder="What would you like to ask?" onChange={e => setUserInput(e.target.value)} />
